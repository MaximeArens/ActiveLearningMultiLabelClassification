...
class ActiveLearningRun(object):
    ...
    def execute(self, run_id, train_set, test_set):
        ...
        self.metrics_tracker.track(run_id, 0, len(active_learner.indices_labeled), run_results)
    ...
    def post_query(self, active_learner, ind, q, run_id, run_results, scores, y_train):
        ...
        self.metrics_tracker.track(run_id, q, len(active_learner.indices_labeled),
                                   run_results)
    ...
    def run_query(self, active_learner, q, run_id, train_set, test_set,
        ...
        x_indices_labeled = active_learner.indices_labeled
